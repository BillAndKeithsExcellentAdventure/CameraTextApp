    ...
    <View style={styles.container}>
      ...
      {images && !showMap && (
        <ScrollView>
          {images.map((img) => (
            <View key={img.id}>
              <TouchableOpacity style={styles.button} onPress={() => openMap (img.latitude, img.longitude, img.filename)}>
      ...
      {showMap && (
        <View style={styles.mapContainer}>
          ...
          <MapComponent latitude={currentLat} longitude={currentLong} markerTitle={currentFilename} />
        </View>
      )}
    </View>
  );
